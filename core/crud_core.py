...
with engine.connect() as conn:
    input_1 = crud_core.insert(Customers).values(first_name='Artem',
                                            ...
                                            last_name='Sirotin',
                                            phone='79998207171')
    input_2 = crud_core.insert(Customers).values(first_name='Alex', middle_name='Aleksandovich', last_name='Batashev', phone='79998207272')
    input_3 = crud_core.insert(Customers).values(first_name='Oleg', middle_name='Olegovich', last_name='Olegov', phone='79998207475')
...
with engine.connect() as conn:
    ...
    # +
    # select_1 = crud_core.select(Autos.c.brand).group_by(Autos.c.brand)
